        ...
        <MDBContainer className='text-center text-md-start mt-5'>
          <MDBRow className='mt-3'>
            <MDBCol md='3' lg='4' xl='5' className='mx-auto mb-4'>
              ...
              <p style={{ color: '#ffff',  fontSize: '15px' , textAlign: 'justify' }}>
...
?subject=Hello&body=Hi there!'
          ...
          <MDBBtn
            floating
            className='m-1'
            style={{ backgroundColor: '#ac2bac', borderColor: '#ac2bac' }}
          ...
          <MDBBtn
            floating
            className='m-1'
            style={{ backgroundColor: '#0082ca', borderColor: '#0082ca' }}
          ...
          <MDBBtn
            floating
            className='m-1'
            style={{ backgroundColor: '#333333' , borderColor: '#ffff' }}
